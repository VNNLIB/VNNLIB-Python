...
class HiddenNodeTheory(Enum):
    NH: HiddenNodeTheory
    H: HiddenNodeTheory

class MultipleInputOutputTheory(Enum):
    SIO: MultipleInputOutputTheory
    MIO: MultipleInputOutputTheory

class MultipleNetworkTheory(Enum):
    SNET: MultipleNetworkTheory
    MENET: MultipleNetworkTheory
    MINET: MultipleNetworkTheory
    MNET: MultipleNetworkTheory

class MultipleNodeComparisonTheory(Enum):
    SNC: MultipleNodeComparisonTheory
    MNC: MultipleNodeComparisonTheory

class ArithmeticComplexityTheory(Enum):
    BND: ArithmeticComplexityTheory
    OUTC: ArithmeticComplexityTheory
    LIN: ArithmeticComplexityTheory
    POLY: ArithmeticComplexityTheory
...
class Solver:
    ...
    def supports_hidden_node_theories(self) -> List[HiddenNodeTheory]: ...
    def supports_multiple_input_output_theories(self) -> List[MultipleInputOutputTheory]: ...
    def supports_multiple_network_theories(self) -> List[MultipleNetworkTheory]: ...
    def supports_multiple_node_comparison_theories(self) -> List[MultipleNodeComparisonTheory]: ...
    def supports_arithmetic_complexity_theories(self) -> List[ArithmeticComplexityTheory]: ...
